...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.customer'); ?> <?php echo app('translator')->get('lang.edit'); ?></h1>
            <div class="bc-pages">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.customer'); ?> <?php echo app('translator')->get('lang.edit'); ?></h3>
                </div>
            </div>
        </div>
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['admin.customer_update',@$data->id], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' =>'profile'])); ?>
                            ...
                            <div class="input-effect">
                                ...
                                <div class="row col-lg-9 mb-30">
                                    ...
                                    <div class="col-lg-6 mt-40">
                                            ...
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input form-control <?php echo e($errors->has('staff_photo') ? ' is-invalid' : ''); ?>" id="placeholderStaffsName" type="text" placeholder="<?php echo e(@$data->profile->image != ""? showPicName(@$data->profile->image):'Profile Photo'); ?>"
                                                    readonly >
                                                    <span class="focus-border"></span>
...
<div class="row mt-40">
    <div class="col-lg-12 text-center">
        <button class="primary-btn fix-gr-bg">
            ...
            <?php echo app('translator')->get('lang.customer'); ?> <?php echo app('translator')->get('lang.update'); ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/customer/customerEdit.blade.php ENDPATH**/ ?>