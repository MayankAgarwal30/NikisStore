                                ...
                                <?php $__currentLoopData = $color_styles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $background_setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->primary_color); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->primary_color2); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->primary_color3); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->title_color); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->text_color); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class=" col-lg-2">
                                                    <div class="bg-color_general_settings"  style="background: <?php echo e($background_setting->sidebar_bg); ?>"></div>
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <?php if($background_setting->is_active==1): ?>
                                                <a class="primary-btn small fix-gr-bg "
                                                   href="#">  <?php echo app('translator')->get('lang.activated'); ?> </a>
                                            <?php else: ?>
                                                <a class="primary-btn small tr-bg"
                                                   href="<?php echo e(route('default_color_theme',$background_setting->id)); ?>">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/Modules/Systemsetting/Resources/views/theme_setting.blade.php ENDPATH**/ ?>