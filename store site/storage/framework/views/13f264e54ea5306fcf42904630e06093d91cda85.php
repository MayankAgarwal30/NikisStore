...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.request' ); ?> <?php echo app('translator')->get('lang.refund'); ?> <?php echo app('translator')->get('lang.list'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('admin/dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#" class="active"><?php echo app('translator')->get('lang.request' ); ?> <?php echo app('translator')->get('lang.refund'); ?> <?php echo app('translator')->get('lang.list'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title lm_mb_35 sm_mb_20  ">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.request' ); ?> <?php echo app('translator')->get('lang.refund'); ?> <?php echo app('translator')->get('lang.list'); ?> </h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><?php echo app('translator')->get('lang.download'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top"><a target="_blank" href="<?php echo e(route('singleProduct',[str_replace(' ', '-',@$item->Item->title),@$item->item_id])); ?>"><?php echo e(Str::limit(@$item->Item->title,20)); ?></a></td>
                                    ...
                                    <td valign="top">
                                        ...
                                        <?php echo e($item->download_status); ?>
                                    ...
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item" data-toggle="modal" data-target="#giveRefund<?php echo e(@$item->id); ?>"  href="#"><?php echo app('translator')->get('lang.give'); ?> <?php echo app('translator')->get('lang.Refund'); ?></a>
                                            <a href="<?php echo e(route('admin.refundApprove',@$item->id)); ?>" id="Approve-<?php echo e(@$item->id); ?>" hidden></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <div class="modal fade admin-query" id="showBlogModal<?php echo e(@$item->id); ?>" >
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="text-center">
                                                    <h4 class="modal-title"><?php echo app('translator')->get('lang.request' ); ?> <?php echo app('translator')->get('lang.refund'); ?></h4>
                                                </div>
                                    ...
                                    <div class="modal fade admin-query" id="giveRefund<?php echo e(@$item->id); ?>" >
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"><?php echo app('translator')->get('lang.approve'); ?> <?php echo app('translator')->get('lang.refund'); ?></h4>
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                </div>
    
                                                <div class="modal-body">
                                                    <div class="text-center">
                                                        <h4><?php echo app('translator')->get('lang.are_you_want_to_refund'); ?></h4>
                                                    </div>
    
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->get('lang.cancel'); ?></button>
                                                          <a href="<?php echo e(route('admin.refundApprove',@$item->id)); ?>" class="text-light">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/refund/request_refund_item.blade.php ENDPATH**/ ?>