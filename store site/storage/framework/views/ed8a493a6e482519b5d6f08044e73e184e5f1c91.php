...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.about'); ?> <?php echo app('translator')->get('lang.company'); ?></h1>
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('lang.about'); ?> <?php echo app('translator')->get('lang.company'); ?> </a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"> <?php echo app('translator')->get('lang.update'); ?>
                                <?php echo app('translator')->get('lang.about'); ?> <?php echo app('translator')->get('lang.company'); ?>
                            </h3>
                        </div>
                      
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'about-company-update',
                                ...
                                <div class="row mt-40"> 
                                    <div class="col-lg-12">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderPhoto" placeholder="<?php echo e(@$image[array_key_last ($image)]); ?>" readonly="">
                                                    <span class="focus-border"></span>
                                                </div>
                                            </div>
                                            <div class="col-auto">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/Modules/Pages/Resources/views/aboutCompany.blade.php ENDPATH**/ ?>