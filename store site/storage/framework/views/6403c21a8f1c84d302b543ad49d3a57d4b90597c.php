...
?>
  <?php
    ...
    ?>
<!DOCTYPE html>
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(checkRTL(app()->getLocale())); ?>" class="<?php echo e(checkRTL(app()->getLocale())); ?>">
   
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <link rel="icon" href="<?php echo e(url('/')); ?>/<?php echo e($favicon->image); ?>" type="image/png"/>
    
    <title><?php echo e(@$system_name); ?> | <?php echo e(@$system_title); ?></title>
    <meta name="_token" content="<?php echo csrf_token(); ?>"/>
    <!-- Bootstrap CSS -->
    <?php if(checkRTL(app()->getLocale()) =='rtl'): ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('public/backEnd/')); ?>/css/color_picker/rgbaColorPicker.css"/>
...
<body class="admin" style="<?php echo e(@$css); ?>">
...
<?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/partials/header.blade.php ENDPATH**/ ?>