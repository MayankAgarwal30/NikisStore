...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.author'); ?> <?php echo app('translator')->get('lang.revenue'); ?></h1>
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('admin.revenue')); ?>"><?php echo app('translator')->get('lang.author'); ?> <?php echo app('translator')->get('lang.revenue'); ?></a>
            </div>
        </div>
    </div>
</section>
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="white-box">
                <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'admin.authorRevenue', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>

                        <div class="row">
                            <input type="hidden" name="url" id="url" value="<?php echo e(URL::to('/')); ?>">
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('author') ? ' is-invalid' : ''); ?>"
                                            name="author" id="select_author">
                                        <option data-display="<?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.author'); ?>" value=""><?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.author'); ?>
                                        </option>
                                        <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option data-display="<?php echo e($author->username); ?>" value="<?php echo e($author->id); ?>"> <?php echo e($author->username); ?> </option>
                            ...
                            <div class="col-lg-2 mt-30-md" id="select_product_div">
                                <select class="w-100 bb niceSelect form-control<?php echo e(@$errors->has('product') ? ' is-invalid' : ''); ?>" id="select_product" name="product">
                                    <option data-display="<?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.product'); ?>" value=""><?php echo app('translator')->get('lang.select'); ?> <?php echo app('translator')->get('lang.product'); ?></option>
                                </select>
                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                                ...
                                $income=0.00;
                            ?>
                            <?php $__currentLoopData = $revenue_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $sale_count++;
                               $income+= $item['author'];
                            ?>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2"><?php echo e($income); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/report/author_revenue.blade.php ENDPATH**/ ?>