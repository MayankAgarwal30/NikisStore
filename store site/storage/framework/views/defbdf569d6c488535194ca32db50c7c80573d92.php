...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.terms'); ?> <?php echo app('translator')->get('lang.conditions'); ?></h1>
            <div class="bc-pages">
                ...
                <a href="#"><?php echo app('translator')->get('lang.terms'); ?> <?php echo app('translator')->get('lang.&'); ?> <?php echo app('translator')->get('lang.conditions'); ?> </a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="col-lg-12">
                        <div class="main-title">
                            <h3 class="mb-30"> <?php echo app('translator')->get('lang.update'); ?>
                                <?php echo app('translator')->get('lang.terms'); ?> <?php echo app('translator')->get('lang.&'); ?> <?php echo app('translator')->get('lang.conditions'); ?>
                            </h3>
                        </div>
                      
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'terms-conditions-update',
                        ...
                        <div class="white-box">
                            <div class="add-visitor">  
                                    ...
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('heading_title') ? ' is-invalid' : ''); ?>"
                                                type="text" name="heading_title" autocomplete="off" value="<?php echo e(isset($editData)? $editData->heading_title:old('heading_title')); ?>">
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('lang.sub'); ?> <?php echo app('translator')->get('lang.title'); ?> <span class="text-red">*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12"> 
                                        <div class="input-effect">
                                            <textarea name="short_description" class="primary-input form-control<?php echo e($errors->has('short_description') ? ' is-invalid' : ''); ?>" rows="5"><?php echo e(isset($editData)? $editData->short_description:old('short_description')); ?></textarea> 
                                            <label><?php echo app('translator')->get('lang.short'); ?> <?php echo app('translator')->get('lang.description'); ?> <span class="text-red">*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40"> 
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect">
                                                    <input class="primary-input" type="text" id="placeholderPhoto" placeholder="<?php echo app('translator')->get('lang.upload'); ?> <?php echo app('translator')->get('lang.image'); ?>" readonly="">
                                                    <span class="focus-border"></span>
                                                </div>
                                            </div>
                                            <div class="col-auto">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/Modules/Pages/Resources/views/termsConditions.blade.php ENDPATH**/ ?>