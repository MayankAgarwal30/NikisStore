...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.Product'); ?> <?php echo app('translator')->get('lang.update'); ?> <?php echo app('translator')->get('lang.list'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('admin/dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="#" class="active"><?php echo app('translator')->get('lang.Product'); ?> <?php echo app('translator')->get('lang.update'); ?>  <?php echo app('translator')->get('lang.list'); ?></a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title sm_mb_20 lm_mb_35">
                            <h3 class="mb-0"><?php echo app('translator')->get('lang.Product'); ?> <?php echo app('translator')->get('lang.preview'); ?> <?php echo app('translator')->get('lang.list'); ?> </h3>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                                ...
                                                <?php endif; ?>
                                                <?php if( @$item->active_status == 2): ?>                                        
                                                <font color="orange"> <?php echo app('translator')->get('lang.soft_rejected'); ?></font>
                                                <?php endif; ?>
                                                <?php if( @$item->active_status == 3): ?>                                        
                                                <font color="red"> <?php echo app('translator')->get('lang.hard_rejected'); ?></font>
                                                <?php endif; ?>
                                    </td>
                                    <td><a valign="top"><a href="" data-toggle="modal" data-target="#FeedBack<?php echo e($item->id); ?>"  class="primary-btn small fix-gr-bg"><?php echo app('translator')->get('lang.feedback'); ?></a></td>  </td>
                                    <td valign="top">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                             <a class="dropdown-item" target="_blank" href="<?php echo e(route('singleProduct',[str_replace(' ', '-',@$item->title),@$item->item_id])); ?>"><?php echo app('translator')->get('lang.view'); ?></a>
                                                <a class="dropdown-item" target="_blank" href="<?php echo e(route('admin.contentEdit',@$item->item_id)); ?>"><?php echo app('translator')->get('lang.edit'); ?></a>
                                                <a class="dropdown-item" target="_blank" href="<?php echo e(route('admin.ProductDownload',@$item->item_id)); ?>"><?php echo app('translator')->get('lang.download'); ?></a> 
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('admin.item_feedback_direct',@$item->id)); ?>"><?php echo app('translator')->get('lang.approve'); ?></a>                           
                                                ...
                                                <?php else: ?>   
                                                   <a class="dropdown-item" data-toggle="modal" data-target="#ApproveClassModal<?php echo e(@$item->id); ?>"  href=""> <?php echo app('translator')->get('lang.approve'); ?></a>
                                                <?php endif; ?>
                                  ...
                                  <div class="modal fade admin-query" id="deleteClassModal<?php echo e(@$item->id); ?>" >
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    ...
                                                    <a href="<?php echo e(route('admin.previewitemDelete',@$item->id)); ?>" class="text-light">
                                    ...
                                    <div class="modal fade admin-query " id="FeedBack<?php echo e(@$item->id); ?>" >
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo e(route('admin.item_review_feedback',@$item->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="row mt-40">
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="input-effect">
                                                                    <input class="primary-input form-control<?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?>" id="subject" name="subject">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mt-40 d-flex justify-content-between">
                                                    <button type="button" class="primary-btn tr-bg" data-dismiss="modal"><?php echo app('translator')->get('lang.cancel'); ?></button>
                                                    <a href="<?php echo e(route('admin.item_preview_approve',@$item->id)); ?>" class="text-light">
                                                            <?php if(@$item->active_status == 1): ?>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/product/item_review.blade.php ENDPATH**/ ?>