...
?>
<link rel="stylesheet" href="<?php echo e(asset('public/backEnd/css/')); ?>/agent.css">

<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1><?php echo app('translator')->get('lang.agent'); ?> <?php echo app('translator')->get('lang.edit'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('admin/dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="<?php echo e(route('admin.agent')); ?>"><?php echo app('translator')->get('lang.agent'); ?> <?php echo app('translator')->get('lang.list'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.agent'); ?> <?php echo app('translator')->get('lang.edit'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('lang.agent'); ?> <?php echo app('translator')->get('lang.edit'); ?></h3>
                </div>
            </div>
        </div>
        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['admin.agent_update',@$data->id], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' =>'profile'])); ?>
                            ...
                            <div class="row mb-30 mt-20">
                                    <div class="col-lg-3">
                                        <div class="input-effect">
                                            <input class="primary-input form-control<?php echo e($errors->has('username') ? ' is-invalid' : ''); ?>" type="text"  name="username" readonly value="<?php echo e((isset($data->username)) ? $data->username : old('username')); ?>">
                                    ...
                                    <div class="col-lg-6 mt-20">
                                        <div class="input-effect">
                                            <textarea class="primary-input form-control <?php echo e($errors->has('address') ? 'is-invalid' : ''); ?>" cols="0" rows="4" name="address" id="address"><?php echo e((isset($data->profile->address)) ? $data->profile->address : old('address')); ?></textarea>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12 text-center">
                                <button class="primary-btn fix-gr-bg">
                                    ...
                                    <?php echo app('translator')->get('lang.agent'); ?> <?php echo app('translator')->get('lang.update'); ?>
                                </button>
                            </div>
                        </div>
</div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/agent/agentEdit.blade.php ENDPATH**/ ?>