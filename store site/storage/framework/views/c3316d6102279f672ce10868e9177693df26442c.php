...
<div class="modal fade invoice-details" id="showDetaildModalInvoice">
    <div class="modal-dialog large-modal modal-dialog-centered" >
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo app('translator')->get('lang.add_invoice'); ?></h4>
...
<script src="<?php echo e(asset('public/backEnd/js/')); ?>/pdfmake.min.js"></script> 
...
<script type="text/javascript" src="<?php echo e(asset('public/backEnd/')); ?>/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<?php echo e(asset('public/frontend/js/')); ?>/summernote.min.js"></script>
...
<script src="<?php echo e(asset('public/backEnd/')); ?>/js/color_picker/rgbaColorPicker.js"></script>
...
<script src="<?php echo e(asset('public/backEnd/footer.js')); ?>"></script>
...
<?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/partials/footer.blade.php ENDPATH**/ ?>