...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
                <h1><?php echo app('translator')->get('lang.credit'); ?> <?php echo app('translator')->get('lang.card'); ?> <?php echo app('translator')->get('lang.view'); ?></h1>
            <div class="bc-pages">
                <a href="<?php echo e(url('admin/dashboard')); ?>"><?php echo app('translator')->get('lang.dashboard'); ?></a>
                <a href="<?php echo e(route('admin.CreditCard')); ?>"><?php echo app('translator')->get('lang.credit'); ?> <?php echo app('translator')->get('lang.card'); ?> <?php echo app('translator')->get('lang.list'); ?></a>
                <a href="#"><?php echo app('translator')->get('lang.credit'); ?> <?php echo app('translator')->get('lang.card'); ?> <?php echo app('translator')->get('lang.view'); ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
         <div class="col-lg-3">
            ...
            <div class="main-title">
                <h3 class="mb-20"><?php echo app('translator')->get('lang.credit'); ?> <?php echo app('translator')->get('lang.card'); ?> <?php echo app('translator')->get('lang.view'); ?></h3>
            </div>
            ...
            <div class="col-lg-9 staff-details">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" href="#Earning" role="tab" data-toggle="tab"><?php echo app('translator')->get('lang.credit'); ?> <?php echo app('translator')->get('lang.card'); ?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade show active" id="Earning">
                            ...
                            <div class="single-info">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="">
                                            <?php if(isset($data)): ?><?php echo e(@$data->name); ?><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mt-40">
                                    ...
                                    <a href="<?php echo e(route('admin.CreditCardViewApprove',@$data->id)); ?>" class="primary-btn fix-gr-bg">
                                    ...
                                    <?php if(@$data->status != 1): ?>
                                        <a href="<?php echo e(route('admin.CreditCardViewReject',@$data->id)); ?>" class="primary-btn fix-gr-bg">
                                                <span class="ti-check"></span>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/backend/payment/credit_card_view.blade.php ENDPATH**/ ?>