                            ...
                            <div class="search-field">
                                <div class="search-field-inner">
                                    <form class="search-relative" action="<?php echo e(route('_by_search')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <input type="text" placeholder="<?php echo app('translator')->get('lang.search_your_product'); ?>"  name="key">  
                                            ...
                                            <div class="catagori-submenu-inner">
                                                ...
                                                <div class="catagori-content">
                                                    <ul>
                                                        ...
                                                        ?> 
                                                        <?php if($catCount > 0): ?>                                                            
                                                           <li><a href="<?php echo e(route('searchCategoryItem',strtolower(str_replace(' ', '_',@$val)))); ?>"><?php echo e(@$val); ?> <span> (<?php echo e(@$catCount); ?>)</span></a></li>
                                                        <?php endif; ?>                                                       
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="catagori-content">
                                                    <ul>                                  
                                                         ...
                                                         ?> 
                                                             ...
                                                             <?php if(@$val && @$number > 0): ?> 
                                                               <li><a href="<?php echo e(@$data['sub_cat']? route('tagSubItem',[@$data['category']->slug,@$data['sub_cat']->slug,'tag',strtolower(str_replace(' ', '_',@$val))]) : route('tagCatItem',[@$data['category']->slug ? @$data['category']->slug:@$_cat_slug->slug,'tags',strtolower(str_replace(' ', '_',@$val))])); ?>"><?php echo e(@$val); ?><span> (<?php echo e(@$number); ?>)</span></a></li>                                                        
                                                             <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script src="<?php echo e(asset('public/frontend/js/')); ?>/search.js"></script>

<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u522089564/domains/infixlive.com/public_html/infixhub/resources/views/frontend/pages/search.blade.php ENDPATH**/ ?>