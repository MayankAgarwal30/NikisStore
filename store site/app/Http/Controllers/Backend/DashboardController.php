...
class DashboardController extends Controller
{
    ...
    function index(){
        ...
        try {
            ...
            return view('backend.dashboard_ga',compact('data','result', 'Yearstr', 'yearlyValue','top_ten_seller','new_ten_seller','Activeuser',
            'ActiveCustomer','ActiveVendor','blocked_users','ActiveItem','TotalItem','InactiveItem','ItemSale','ItemEarning','update_pending'));

        } catch (\Google\Service\Exception $ga) {

            return view('backend.dashboard',compact('result', 'Yearstr', 'yearlyValue','top_ten_seller','new_ten_seller','Activeuser',
            'ActiveCustomer','ActiveVendor','blocked_users','ActiveItem','TotalItem','InactiveItem','ItemSale','ItemEarning','update_pending'));
