<div class="mca_chat_wrapper mca_chat_wrapper_new_c">
				...
				<li>
                    <div class="mca_user">
                        ...
                        <div class="mca_action">
                            <a href="" class="mca_btn admin_chat_open" data-cust_id="<?php echo $customer[$i]->user_id; ?>" data-name="<?php echo $customer[$i]->name; ?>" data-agent_id="<?php echo $agent_id; ?>">Chat Now</a>
                        </div>
                    </div>
